...
def mock_session_service() -> MagicMock:
    ...
    # Custom side effect for validate_refresh_token
    ...
    service.validate_refresh_token = AsyncMock(side_effect=mock_validate)
    service.create_session = AsyncMock()
    service.logout_by_refresh_token = AsyncMock()
    return service
